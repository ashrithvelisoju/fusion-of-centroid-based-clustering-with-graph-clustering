...
def plot_clusters(X_scaled, labels, features, centroids=None):
...
def plot_network(X_scaled, labels, similarities, threshold=90):
...
def main():
    ...
    tab1, tab2, tab3 = st.tabs(["Scatter Plot", "Cluster Statistics", "Network Graph"])
